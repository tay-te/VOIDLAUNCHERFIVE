/**
 * Fullbright — what gamma does to a light level.
 *
...
import { FullbrightPreview } from '@/menu/gameplay-previews';

function FullbrightPreviewThumbnail(): React.ReactElement {
  return <FullbrightPreview dense className="tart" />;
}

export default defineMod({
  id: 'fullbright',
  Thumbnail: FullbrightPreviewThumbnail,
  Preview: FullbrightPreview,
});
